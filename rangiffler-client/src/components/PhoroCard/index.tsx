...
export const PhotoCard: FC<PhotoCardInterface> = ({photo, onClose, initSubmitPopupAndOpen}) => {
    ...
    const selectOptions = countries?.map(country => (<MenuItem value={country.code} key={country.code}>{country.name}</MenuItem>));
                                     ...
                                     <form onSubmit={!photo ? handleAddPhotoClick : handleEditPhotoClick }>
                                         ...
                                         <Grid item sx={{textAlign: "center"}}>
                                             <Select
                                                 ...
                                                 MenuProps={{ PaperProps: {sx:{maxHeight: 170}}}}                                             onChange={event =>  setPhotoData({
                                                     ...photoData,
                                         ...
                                         <Grid item sx={{textAlign: "center"}}>
                                             <LoadingButton variant="contained" type="submit" disabled={!photoData?.src}>Save</LoadingButton>
                                         </Grid>
                                     </Grid>
                                 </form>
                             </>)
