...
export const Layout = () => {
    ...
    return (
        <div className="App">
            <Header handleAvatarClick={handleAvatarClick} handleAddPhotoClick={handleAddPhotoClick} handleFriendsIconClick={handleFriendsIconClick} friends={friendsData}/>
            <main className="content">
                {photoCardOpen && <PhotoCard key={selectedItem?.src} photo={selectedItem} onClose={handleClosePopup} initSubmitPopupAndOpen={initSubmitPopupAndOpen}/>}
                {profileOpen && <Profile onClose={handleClosePopup}/>}
                {submitPopupOpen && <Popup onSubmit={submitPopupData.onSubmit} onClose={handleClosePopup} text={submitPopupData.text}/> }
                {friendsPopupOpen && <FriendsPopup friends={friendsData} onClose={handleClosePopup} handleRemoveFriend={handleDeleteFriend}/>}
